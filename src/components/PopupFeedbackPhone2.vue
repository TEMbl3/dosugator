<template>
  <div class="flex max-[600px]:hidden w-[100vw] h-[480px] z-20 fixed top-0 left-0 bg-[#2A2A2A] opacity-50" />
  <div style="box-sizing: border-box; box-shadow: 0 12px 30px black" v-if="visible" @touchstart="handleTouchStart"
    @touchmove="handleTouchMove" @touchend="handleTouchEnd" :style="{
      transform: `translateY(${translateY}px)`,
      transition: isAnimating ? 'transform 0.3s ease-out' : 'none',
    }"
    class="flex min-w-[100vw] h-[430px] min-h-[30px] z-[99999] fixed max-[600px]:min-h-[430px] bottom-[50px] rounded-t-[12px] max-[600px]:bg-[white] max-[600px]:max-h-[510px] max-[600px]:pb-[80px] left-0 max-[600px]:block justify-center items-center">
